...
export const Container = styled(CardMedia)<ContainerProps>`
  ...
  props.size === undefined && rsize(287)
  }px;  
  flex-direction: row;
  align-items: center;
  ...
  css`background-color: ${props => props.theme.colors.backgroundSecondary};` :
  css`background-color: ${props => props.theme.colors.backgroundPrimary};`
  };
`
...
export const ImageContainerSM = styled.View<ImageContainerProps>`
  ...
  css`width: ${rsize(44)}px;` :
  css`width: ${rsize(59)}px;`
  };
  align-items: center;
...
export const ImageContainerMD = styled(ImageContainerSM)`
  ${props => props.background === "secondary" ?
  css`width: ${rsize(54)}px;` :
  css`width: ${rsize(67)}px;`
  };
`
